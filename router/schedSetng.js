...
router.put("/api/schedule", async (req, res)=>{
    ...
    if(teacher.length){
        if(shedInfo.group != teacher[1].group || teacher[0].group && 
            shedInfo.semester == teacher[1].semester || teacher[0].semester && 
            shedInfo.kurs == teacher[1].kurs || teacher[0].kurs && 
            shedInfo.day == teacher[1].day || teacher[0].day &&
            shedInfo.pair == teacher[1].pair || teacher[0].pair &&
            lesson == teacher[1].lesson || teacher[0].lesson &&
            lecture == teacher[1].lecture || teacher[0].lecture &&
            firstTime == teacher[1].firstTime || teacher[0].firstTime &&
            secondTime == teacher[1].secondTime || teacher[0].secondTime &&
            cabinetId == teacher[1].roomId || teacher[0].roomId){
